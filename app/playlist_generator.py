...
class PlaylistGenerator:
    ...
    def get_user_spotify_export(self):
        try:
            ...
            liked_tracks = self.spotipy.current_user_saved_tracks(limit=50)
            followed_artists = self.spotipy.current_user_followed_artists(limit=50)
            recently_played = self.spotipy.current_user_recently_played(limit=50)
